...
simple_shell is an ALX School project in the first section of their cirriculum, that helps student to understand the advanced concepts behind the shell program include process, system call, bit manipulation, file managment, error handling ...
